...
class Parallel{
	...
	//事件
	const EVENT_ON_START = __CLASS__.'ON_START';
	const EVENT_ON_ALL_DONE = __CLASS__.'ON_ALL_DONE';
	const EVENT_ON_PROCESS_ERROR = __CLASS__.'ON_PROCESS_ERROR';
	const EVENT_ON_PROCESS_ADD = __CLASS__.'ON_PROCESS_ADD';
	const EVENT_ON_PROCESS_FINISH = __CLASS__.'ON_PROCESS_FINISH';
	const EVENT_ON_PROCESS_RUNNING = __CLASS__.'ON_PROCESS_RUNNING';
	const EVENT_ON_PROCESS_INTERRUPT = __CLASS__.'ON_PROCESS_INTERRUPT';
